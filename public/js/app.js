...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var objectsData = window.objectsData || [];
  if (objectsData.length === 0) {
    var _document$getElementB, _document$getElementB2;
    console.warn('Предупреждение: window.objectsData не найден или пуст.');
    (_document$getElementB = document.getElementById('prevObject')) === null || _document$getElementB === void 0 || _document$getElementB.setAttribute('disabled', 'disabled');
    (_document$getElementB2 = document.getElementById('nextObject')) === null || _document$getElementB2 === void 0 || _document$getElementB2.setAttribute('disabled', 'disabled');
    return;
  }

  // Обработчик клика по карточке
  document.querySelectorAll('.card-wrapper').forEach(function (card, index) {
  ...
  document.getElementById('prevObject').addEventListener('click', function () {
    if (currentObjectIndex > 0) {
      updateModal(currentObjectIndex - 1, objectsData);
    }
  });
  document.getElementById('nextObject').addEventListener('click', function () {
  ...
  document.getElementById('detailModal').addEventListener('keydown', function (event) {
  ...
  document.getElementById('loadButton').addEventListener('click', function () {
    ...
    var toastInstance = bootstrap__WEBPACK_IMPORTED_MODULE_0__.Toast.getInstance(toastEl);
    if (toastInstance) {
      toastInstance.show();
    } else {
      toastInstance = new bootstrap__WEBPACK_IMPORTED_MODULE_0__.Toast(toastEl);
      toastInstance.show();
    }
  });
